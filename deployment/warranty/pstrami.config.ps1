...
Role "Web" -Incremental {
	...
	poke-xml "$web_directory\web.config" "configuration/connectionStrings/add[@name='SecurityDB']/@connectionString" "Data Source=$security_db_server;Initial Catalog=$security_db_name;user id=headspringsql;password=281&gt;512;"
