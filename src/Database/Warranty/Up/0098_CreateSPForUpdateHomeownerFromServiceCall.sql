CREATE PROCEDURE imports.ImportHomeownerFromCall @CityCodeList VARCHAR(4000) AS
...
CASE WHEN LEN(LTRIM(RTRIM(Home_Phone))) = 0 THEN 'NULL' ELSE '''' + REPLACE(LTRIM(RTRIM(Home_Phone)),'''','''''') + '''' END as home_phone,
CASE WHEN LEN(LTRIM(RTRIM(other_phone))) = 0 THEN 'NULL' ELSE '''' + REPLACE(LTRIM(RTRIM(other_phone)),'''','''''') + '''' END as other_phone,
CASE WHEN LEN(LTRIM(RTRIM(workphone_1))) = 0 THEN 'NULL' ELSE '''' + REPLACE(LTRIM(RTRIM(workphone_1)),'''','''''') + '''' END as workphone_1,
CASE WHEN LEN(LTRIM(RTRIM(workphone_2))) = 0 THEN 'NULL' ELSE '''' + REPLACE(LTRIM(RTRIM(workphone_2)),'''','''''') + '''' END as workphone_2,
...
CASE WHEN LEN(LTRIM(RTRIM(Home_Phone))) = 0 THEN 'NULL' ELSE '''' + REPLACE(LTRIM(RTRIM(Home_Phone)),'''','''''') + '''' END ,
CASE WHEN LEN(LTRIM(RTRIM(other_phone))) = 0 THEN 'NULL' ELSE '''' + REPLACE(LTRIM(RTRIM(other_phone)),'''','''''') + '''' END,
CASE WHEN LEN(LTRIM(RTRIM(workphone_1))) = 0 THEN 'NULL' ELSE '''' + REPLACE(LTRIM(RTRIM(workphone_1)),'''','''''') + '''' END,
CASE WHEN LEN(LTRIM(RTRIM(workphone_2))) = 0 THEN 'NULL' ELSE '''' + REPLACE(LTRIM(RTRIM(workphone_2)),'''','''''') + '''' END,
