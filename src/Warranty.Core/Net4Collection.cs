...
namespace Warranty.Core
{
    ...
    public class PersistentGenericSet<T> : AbstractPersistentCollection, ISet<T>
    {
        ...
        private interface ISetSnapshot<TElement> : ICollection<TElement>, ICollection
        {
            TElement this[TElement element] { get; }
        }
        ...
        [Serializable]
        private class SetSnapShot<TElement> : ISetSnapshot<TElement>
        {
            ...
            public SetSnapShot(IEnumerable<TElement> collection)
            {
                elements = new List<TElement>(collection);
            }
            ...
            public bool IsReadOnly
            {
                get { return ((ICollection<TElement>)elements).IsReadOnly; }
            }

            public TElement this[TElement element]
            {
                get
                {
