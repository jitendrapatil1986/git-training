namespace Warranty.Core.Features.PercentClosedWithinSevenDaysWidget
{
    ...
    public class PercentClosedWithinSevenDaysWidgetWSRQueryHandler : IQueryHandler<PercentClosedWithinSevenDaysWidgetWSRQuery, PercentClosedWithinSevenDaysWidgetModel>
    {
        ...
        public PercentClosedWithinSevenDaysWidgetWSRQueryHandler(IDatabase database, IUserSession userSession)
        {
            _database = database;
            _userSession = userSession;
        }

        public PercentClosedWithinSevenDaysWidgetModel Handle(PercentClosedWithinSevenDaysWidgetWSRQuery query)
        {
