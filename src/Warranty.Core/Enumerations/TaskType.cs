namespace Warranty.Core.Enumerations
{
    ...
    public class TaskType : Enumeration<TaskType>
    {
        ...
        public static readonly TaskType QualityIntroductionofWSR = new TaskType(8, "Job is at Stage 3 - time to schedule a Quality Introduction of WSR.", true, 1, "Quality Introduction of WSR");
