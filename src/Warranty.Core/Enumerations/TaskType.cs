namespace Warranty.Core.Enumerations
{
    ...
    public class TaskType : Enumeration<TaskType>
    {
        ...
        public static readonly TaskType JobStage3 = new TaskType(8, "Job is at Stage 3 - time to schedule a Quality Introduction of WSR.", true, 3, "Warranty Introduction");
